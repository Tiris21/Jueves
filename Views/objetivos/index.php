  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Mis Objetivos</li>
      </ol>
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-footer bg-danger text-white">
              <div>
                ...
                <div class="pull-right">
                    ...
                    <!-- <button type="button" class="btn btn-outline-light btn-card btn-card-danger" data-toggle="modal" data-target="#avanzarModal"> 
                        <i class="fa fa-fw fa-check-square-o"></i> Avanzar  
                    </button>
                    <button type="button" class="btn btn-outline-light btn-card btn-card-danger" data-toggle="modal" data-target="#asignarModal"> 
                        <i class="fa fa-fw fa-support"></i> Asignar  
                    </button> -->
                </div>
              </div>
            </div>          
            ...
            <div class="card-footer bg-warning text-white">
              <div>
                ...
                <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-outline-light btn-card btn-card-warning" data-toggle="modal" data-target="#avanzarModal"> 
                        <i class="fa fa-fw fa-check-square-o"></i> Avanzar  
                    </button>
                    <button type="button" class="btn btn-outline-light btn-card btn-card-warning" data-toggle="modal" data-target="#asignarModal"> 
                        <i class="fa fa-fw fa-support"></i> Asignar  
                    </button>
                </div>
              </div>
          ...
          <div class="card carta border-warning">
            <div class="card-block card-body ">
              <div>
                <h4 class="card-title text-warning"> Vender más calentadores solares <!-- <i class="fa fa-fw fa-support pull-right"></i> --> </h4> 
              </div>
              <p class="card-text">Llegar a vender un total de 100 calentadores en la sucursal</p>
              <p class="card-text"> <strong>Responsable: </strong> Yo </p>
              <div class="progress">
                <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 68%" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100">68 %</div>
              </div>
            </div>
            <!--  FOOTER CARD -->
            <div class="card-footer bg-warning text-white">
              <div>
                ...
                <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-outline-light btn-card btn-card-primary" data-toggle="modal" data-target="#avanzarModal"> 
                        <i class="fa fa-fw fa-check-square-o"></i> Avanzar  
                    </button>
                    <button type="button" class="btn btn-outline-light btn-card btn-card-primary" data-toggle="modal" data-target="#asignarModal"> 
                        <i class="fa fa-fw fa-support"></i> Asignar  
                    </button>
                </div>
              </div>
            ...
            <div class="card-footer bg-success text-white">
              <div>
                ...
                <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-outline-light btn-card btn-card-success" data-toggle="modal" data-target="#avanzarModal"> 
                        <i class="fa fa-fw fa-check-square-o"></i> Avanzar  
                    </button>
                    <button type="button" class="btn btn-outline-light btn-card btn-card-success" data-toggle="modal" data-target="#asignarModal"> 
                        <i class="fa fa-fw fa-support"></i> Asignar  
                    </button>
                </div>
              </div>
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <input type="number" step="1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
              </div>
                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
          </div>
          <div class="modal-footer">
